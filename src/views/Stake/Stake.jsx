...
function Stake() {
  ...
  const onChangeStake = async (action, isOld) => {
    ...
    if (action === "stake" && gweiValue.gt(ethers.utils.parseUnits(ohmBalance, "gwei"))) {
      return dispatch(error("You cannot stake more than your DAWA balance."));
    }

    if (action === "unstake" && gweiValue.gt(ethers.utils.parseUnits(unstakedVal, "gwei"))) {
      return dispatch(error("You cannot unstake more than your sDAWA balance."));
    }
    await dispatch(
      changeStake({
        address,
                ...
                <div className="card-header">
                  ...
                  {address && oldSohmBalance > 0.01 && (
                    ...
                    >
                      ...
                      <Typography>Migrate sDAWA!</Typography>
                    </Link>
                  )}
                </div>
              </Grid>
                  ...
                  <Grid container spacing={2} alignItems="flex-end">
                    ...
                    <Grid item xs={12} sm={4} md={4} lg={4}>
                      <div className="stake-index">
                        ...
                        <Typography variant="h4">
                          {currentIndex ? <>{trim(currentIndex, 1)} DAWA</> : <Skeleton width="150px" />}
                        </Typography>
                      </div>
                    </Grid>
                  </Grid>
              ...
              <div className="staking-area">
                {!address ? (
                  <div className="stake-wallet-notification">
                    ...
                    <Typography variant="h6">Connect your wallet to stake DAWA</Typography>
                  </div>
                ) : (
                  <>
                      ...
                      <Box className="stake-action-row " display="flex" alignItems="center">
                          ...
                          (!hasAllowance("ohm") && view === 0) || (!hasAllowance("sohm") && view === 1) ? (
                            <Box className="help-text">
                              <Typography variant="body1" className="stake-note" color="textSecondary">
                                {view === 0 ? (
                                  <>
                                    First time staking <b>DAWA</b>?
                                    <br />
                                    Please approve Daowabunga to use your <b>DAWA</b> for staking.
                                  </>
                                ) : (
                                  <>
                                    First time unstaking <b>sDAWA</b>?
                                    <br />
                                    Please approve Daowabunga to use your <b>sDAWA</b> for unstaking.
                                  </>
                                )}
                              </Typography>
                            </Box>
                        ...
                        <TabPanel value={view} index={0} className="stake-tab-panel">
                          {isAllowanceDataLoading ? (
                            ...
                            >
                              {txnButtonText(pendingTransactions, "staking", "Stake DAWA")}
                            </Button>
                          ) : (
                            <Button
                              className="stake-button"
                        ...
                        <TabPanel value={view} index={1} className="stake-tab-panel">
                          {isAllowanceDataLoading ? (
                            ...
                            >
                              {txnButtonText(pendingTransactions, "unstaking", "Unstake DAWA")}
                            </Button>
                          ) : (
                            <Button
                              className="stake-button"
                    ...
                    <div className={`stake-user-data`}>
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{trim(ohmBalance, 4)} DAWA</>}
                        </Typography>
                      </div>
                      ...
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{trimmedBalance} sDAWA</>}
                        </Typography>
                      </div>
                      ...
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{nextRewardValue} sDAWA</>}
                        </Typography>
                      </div>
